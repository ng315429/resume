        ...
        <div class="experience">
          ...
          <div class="experience-box">
            <div class="experience__desc">
              ...
              <div class="description">
                <p class="summary">결제 API 이전 및 PG사 변경으로 인한 신규 개발</p>
                <ul>
            ...
            <div class="experience__desc">
              ...
              <div class="description">
                <p class="summary">일반계정, 소셜계정 통합 및 로그인/회원가입 리뉴얼</p>
                <ul>
            ...
            <div class="experience__desc">
              ...
              <div class="description">
                ...
                <ul>
                  ...
                  <li>Firebase ML Kit (Barcode Scan)연동을 통해 빠른 바코드 등록 기능 및 화면 개발</li>
